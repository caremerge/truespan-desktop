...
```bash
security import /tmp/certificate.p12 -k ~/Library/Keychains/login.keychain-db -P "REDACTED_CERT_PASSWORD" -T /usr/bin/codesign -T /usr/bin/productsign
```
...
- The password for the .p12 is: `REDACTED_CERT_PASSWORD`
